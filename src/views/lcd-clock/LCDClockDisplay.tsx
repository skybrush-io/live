...
const noiseImage =
  'url(data:image/png;base64,)';
...
const presets: Record<'dark' | 'light', PresetEntry[]> = {
  dark: [
    {
...
const call = (
  theme: Theme,
  value: string | ((theme: Theme) => string) | undefined,
  defaultValue: string
): string =>
...
type Props = BoxProps & {
  ...
  id: string;
  onAdd?: (() => void) | null;
  onClockSelected?: (clockId: string) => void;
  onNextPreset?: () => void;
  onRemove?: (() => void) | null;
  preset?: number;
...
const LCDClockDisplay = ({
  ...
  const lcdStyle: Pick<LCDTextProps, 'color' | 'decoration' | 'offSegments'> =
    themeType === 'dark'
      ? {
  ...
  const finalStyle = {
    ...
    backgroundImage: presetProps.noise ? noiseImage : undefined,
    ...style,
  };
...
export default connect(
  ...
  (dispatch: AppDispatch, ownProps: { id: string }) => ({
    onClockSelected(clockId: string) {
