...
export const SET_CURRENT_SERVER_CONNECTION_STATE = 'SET_CURRENT_SERVER_CONNECTION_STATE'
export const UPDATE_CURRENT_SERVER_AUTHENTICATION_SETTINGS = 'UPDATE_CURRENT_SERVER_AUTHENTICATION_SETTINGS'

// Actions related to the authentication dialog
