...
import { SHOW_FEATURE_EDITOR_DIALOG, CLOSE_FEATURE_EDITOR_DIALOG,
  SET_FEATURE_EDITOR_DIALOG_TAB } from './types'

/**
 * Action factory that creates an action that will close the feature editor
 * dialog.
 */
export const closeFeatureEditorDialog = createAction(CLOSE_FEATURE_EDITOR_DIALOG)
 ...
 */
export const setFeatureEditorDialogTab = createAction(SET_FEATURE_EDITOR_DIALOG_TAB)
