...
const FirmwareUploadTargetSelectorPresentation = selectableListOf(
  ...
  {
    dataProvider: 'items',
    displayName: 'FirmwareUploadTargetSelectorPresentation',
    backgroundHint: 'No firmware update targets',
  }
);

const FirmwareUploadTargetSelector = ({ getTargets, ...rest }) => (
  <AsyncGuard
    func={getTargets}
  ...
  >
    {(items) => (
      <FirmwareUploadTargetSelectorPresentation items={items} {...rest} />
    )}
  </AsyncGuard>
);

FirmwareUploadTargetSelector.propTypes = {
